...
import type { VideoCardProps } from '@/types/sermon-form';
import styles from '../index.module.scss';

export default function VideoCard({ videoUrl, videoId, duration, thumbnailUrl, onChange }: VideoCardProps) {
    ...
    <section className={styles.card}>
      <header className={styles.card_header}>
        ...
        <div>
          ...
          <p className={styles.card_heading_desc}>YouTube 영상을 연결합니다</p>
        </div>
      </header>
