...
export default function usePagination({
  ...
  const pages = useMemo(() => {
    ...
    let startPage = Math.max(2, validatedCurrentPage - half);
    let endPage = Math.min(totalPages - 1, validatedCurrentPage + half);
    ...
    return pageArray;
  }, [totalPages, maxVisiblePages, validatedCurrentPage]);
