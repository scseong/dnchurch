...
export const sitemap: AppSitemapNode[] = [
  ...
  },
  {
    path: '/sermons',
    label: '설교',
    children: [{ path: '/sermons/:id', label: '설교', detail: true }]
  },
  {
    path: '/community',
    label: '교제',
    children: [
      {
        ...
        label: '기도제목',
        children: [{ path: '/community/prayer/:id', label: '기도제목', detail: true }]
      },
      {
        path: '/community/sharing',
        label: '은혜 나눔',
        children: [{ path: '/community/sharing/:id', label: '은혜 나눔', detail: true }]
      },
      {
        path: '/community/groups',
        label: '소모임',
        children: [{ path: '/community/groups/:id', label: '소모임', detail: true }]
      }
    ]
  },
    ...
    children: [
      {
        path: '/news/notices',
        label: '공지사항',
        children: [{ path: '/news/notices/:id', label: '공지사항', detail: true }]
      },
      {
        path: '/news/bulletins',
        label: '주보',
        children: [{ path: '/news/bulletins/:id', label: '주보', detail: true }]
      },
      {
        path: '/news/gallery',
        label: '갤러리',
        children: [{ path: '/news/gallery/:id', label: '갤러리', detail: true }]
      }
    ]
  },
  {
