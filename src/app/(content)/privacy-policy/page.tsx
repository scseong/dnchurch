        ...
        <div className={styles.wrap}>
          ...
          <article className={styles.policy}>
            ...
            <section className={styles.section}>
              ...
              <p>
                권리 행사는 제14조의 개인정보 보호책임자에게 서면·전화·이메일로 요청할 수 있으며,
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                (개인정보보호법 제23조)에 해당할 수 있습니다. 교회는 회원가입 또는 교회 서비스
                이용 과정에서 이러한 민감정보 처리가 필요한 경우, 신앙 공동체 운영과 교적 관리
                목적으로 별도 동의 절차가 마련된 범위 내에서 동의를 받은 후 처리합니다. 정보주체는
                이 동의를 거부할 수 있으며, 거부 시 해당 정보가 필요한 일부 서비스 이용이 제한될
                수 있습니다.
              </p>
            </section>
