...
const VISION_STATEMENT = [
  '동남교회에 오신 것을 환영합니다.',
  '동남교회는 1958년에 설립된 이후, 하나님의 사랑을 나누고 믿음의 공동체를 세우기 위해 함께하는 곳입니다. 우리는 복음을 전파하여 더 많은 사람들이 예수 그리스도를 알게 되고 그 사랑을 경험하도록 힘쓰고 있습니다. 우리의 비전은 하나님의 사랑을 모든 이와 나누고, 서로를 격려하며 지지하는 믿음의 공동체를 형성하는 것입니다.',
